...
void imprimeTitulo() {
    printf("\t\t\t");
    imprimeAsteriscos(69);
    printf("\n\t\t\tSimulacion de una red en tandem con tiempos de servicio Exponenciales\n");
    printf("\t\t\t");
    imprimeAsteriscos(69);
    ...
    printf("\t# El tiempo de servicio para cada servidor es: exponencial de media 1/3 de minuto para el servidor 1, 1/4 de minuto para el servidor 2 y 1/6 de minuto para el servidor 3.\n");
    ...
    printf("\t# Cuando un servidor queda vacío selecciona al primer cliente que esté en cola. (Disciplina de cola FIFO).\n");
